...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [7] = LAYOUT(
    G(KC_DOT),    KC_NO,        LSG(KC_SPC),    G(KC_P),      KC_NO,            KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,
  ...
  [8] = LAYOUT(
    QK_BOOT,        HK_DUMP,       HK_SAVE,       HK_RESET,        HK_C_SCROLL,            KC_NO,    KC_NO,      KC_NO,    KC_NO,    KC_NO,
    QK_C_EEPROM,    HK_P_SET_D,    HK_P_SET_S,    HK_P_SET_BUF,    HK_S_MODE_T,            KC_NO,    KC_DOWN,    KC_UP,    KC_NO,    KC_NO,
